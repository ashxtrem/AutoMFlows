...
function CanvasInner({ savedViewportRef, reactFlowInstanceRef, isFirstMountRef, hasRunInitialFitViewRef, hideSidebar }: CanvasInnerProps) {
  ...
  const currentNodesContentKey = nodes.map(n => {
    const dataHash = JSON.stringify({
      ...
      slowMo: n.data.slowMo,
      key: n.data.key,
      shortcut: n.data.shortcut,
      action: n.data.action,
      selectorModifiers: n.data.selectorModifiers,
      delay: n.data.delay,
      button: n.data.button,
      targetSelector: n.data.targetSelector,
      retryCount: n.data.retryCount,
      retryStrategy: n.data.retryStrategy,
      contextKey: n.data.contextKey,
      method: n.data.method,
      curlCommand: n.data.curlCommand,
