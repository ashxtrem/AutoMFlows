...
exports.BrowserCssStrategy = exports.BrowserStorageStrategy = exports.BrowserCookieStrategy = exports.BrowserFormFieldStrategy = exports.BrowserAttributeStrategy = exports.BrowserElementStrategy = exports.BrowserTextStrategy = exports.BrowserUrlStrategy = void 0;
const base_1 = require("./base");
/**
 * Browser URL Verification Strategy
 */
class BrowserUrlStrategy extends base_1.BaseVerificationStrategy {
...
exports.BrowserUrlStrategy = BrowserUrlStrategy;
/**
 * Browser Text Verification Strategy
 */
class BrowserTextStrategy extends base_1.BaseVerificationStrategy {
    async execute(context, config) {
        const page = context.getPage();
        if (!page) {
            throw new Error('No page available. Ensure Open Browser node is executed first.');
...
exports.BrowserTextStrategy = BrowserTextStrategy;
/**
 * Browser Element Verification Strategy
 */
class BrowserElementStrategy extends base_1.BaseVerificationStrategy {
    async execute(context, config) {
        const page = context.getPage();
        if (!page) {
            throw new Error('No page available. Ensure Open Browser node is executed first.');
...
exports.BrowserElementStrategy = BrowserElementStrategy;
/**
 * Browser Attribute Verification Strategy
 */
class BrowserAttributeStrategy extends base_1.BaseVerificationStrategy {
    async execute(context, config) {
        const page = context.getPage();
        if (!page) {
            throw new Error('No page available. Ensure Open Browser node is executed first.');
...
exports.BrowserAttributeStrategy = BrowserAttributeStrategy;
/**
 * Browser Form Field Verification Strategy
 */
class BrowserFormFieldStrategy extends base_1.BaseVerificationStrategy {
    async execute(context, config) {
        const page = context.getPage();
        if (!page) {
            throw new Error('No page available. Ensure Open Browser node is executed first.');
...
exports.BrowserFormFieldStrategy = BrowserFormFieldStrategy;
/**
 * Browser Cookie Verification Strategy
 */
class BrowserCookieStrategy extends base_1.BaseVerificationStrategy {
    async execute(context, config) {
        const page = context.getPage();
        if (!page) {
            throw new Error('No page available. Ensure Open Browser node is executed first.');
...
exports.BrowserCookieStrategy = BrowserCookieStrategy;
/**
 * Browser Storage Verification Strategy
 */
class BrowserStorageStrategy extends base_1.BaseVerificationStrategy {
    async execute(context, config) {
        const page = context.getPage();
        if (!page) {
            throw new Error('No page available. Ensure Open Browser node is executed first.');
...
exports.BrowserStorageStrategy = BrowserStorageStrategy;
/**
 * Browser CSS Verification Strategy
 */
class BrowserCssStrategy extends base_1.BaseVerificationStrategy {
    async execute(context, config) {
        const page = context.getPage();
        if (!page) {
            throw new Error('No page available. Ensure Open Browser node is executed first.');
...
exports.BrowserCssStrategy = BrowserCssStrategy;
